...
After you open RStudio Cloud, you should be able to see the following:

![](images/RStudioCloud.png)
Click on the classroom (in this case 'Stat 202') workspace to access the available projects. To begin working click 'Start'. Now that the activity project is open navigate to the 'File' pane and open the R Markdown '.rmd' file.
