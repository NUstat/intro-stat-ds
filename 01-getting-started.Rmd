...
Throughout class you will be working on various activities. Once the instructor has made an activity available you will click on the classroom (in this case 'Stat 202') workspace to access the available projects. To begin working on an activity click 'Start'. Once that activity project is open navigate to the 'File' pane and open the R Markdown '.rmd' file.
