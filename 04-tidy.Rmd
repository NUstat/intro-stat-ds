...
### Needed packages {#pkgs-4 .unnumbered}
...
Need to include an exercise in the DataCamp course on using pivot_longer() to turn the `police_locals` data frame into a tidy data frame.
